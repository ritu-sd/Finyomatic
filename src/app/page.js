                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-sm text-gray-500">
                      Track your daily expenses and categorize them for better
                      insights.
                    </p>
                  </div>
                </div>
              ...
              <div className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-sm text-gray-500">
                      Set budgets and monitor your spending against your
                      financial goals.
                    </p>
                  </div>
                </div>
              ...
              <div className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-sm text-gray-500">
                      Generate detailed reports and visualize your financial
                      progress.
                    </p>
                  </div>
                </div>
